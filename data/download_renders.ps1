...
$outDir = "C:\Users\edsel\OneDrive\Desktop\Development Folder\Dota2DraftStructure\dota2draftanalyzer\public\hero_renders"
New-Item -ItemType Directory -Force $outDir | Out-Null

$renderBase = "https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/renders"
$failed = @()

foreach ($hero in $heroes) {
  $dest = "$outDir\$hero.png"
  if (Test-Path $dest) { Write-Host "SKIP $hero"; continue }
  $url = "$renderBase/$hero.png"
  try {
