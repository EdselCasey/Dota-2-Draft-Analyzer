...
const TAG_COLORS: Record<string, string> = {
  stun: '#a855f7', root: '#7c3aed', silence: '#6d28d9', hex: '#8b5cf6', fear: '#8b5df6',
  ...
  small_aoe: '#fde68a', medium_aoe: '#fb923c', large_aoe: '#9a3412',mana_burn: '#c2420d',
  short_range: '#a5f3fc', medium_range: '#22d3ee', long_range: '#0891b2',
  low_heal: '#bbf7d0', medium_heal: '#22c55e', high_heal: '#15803d', slow_resist: '#9fc324',
  low_regen: '#d9f99d', medium_regen: '#84cc16', high_regen: '#4d7c0f',
  short_duration: '#e2e8f0', medium_duration: '#94a3b8', long_duration: '#475569',
  damage_reduction: '#3b82f6', armor_gain: '#2563eb', save: '#1d4ed8',second_life: '#2332d3',
  ...
  dispel: '#14b8a6', debuff_immunity: '#0f766e', vision: '#5eead4',toggle: '#d88817',
  mana_regen: '#6366f1', global: '#4f46e5',antiheal: '#9fc00a',gold_gain: '#6376f2',xp_gain: '#f57102',
  channelled: '#3e74c0',status_resist_reduction: '#9fc21a',
  passive: '#fbbf24', short_cooldown: '#f59e0b', medium_cooldown: '#d97706', long_cooldown: '#bd6717',cooldown_reduction: '#6359f2'
}
