...
export function analyzeMatchup(
  ...
  const direObjDelta    = direPushPower - (radiantNorm.waveclear * 0.40 + radiantNorm.defense * 0.30 + (radiantNorm.hard_control * 0.30 + radiantNorm.soft_control * 0.2) + radiantNorm.reach * 0.15)
