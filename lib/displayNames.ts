...
export const DIMENSION_LABELS: Record<DraftDimension, string> = {
  ...
  burst_damage:       'Burst',
  spell_sustained:    'Spell Sust.',
  attack_sustained:   'Atk. Sust.',
  sustain:            'Sustain',
  defense:            'Defense',
  mobility:           'Mobility',
  reach:              'Reach',
  waveclear:          'Waveclear',
  objective_pressure: 'Obj. Pressure',
  pickoff:            'Pick-off',
...
export const DIMENSION_COLORS: Record<DraftDimension, string> = {
  ...
  soft_control:       '#a855f7',
  burst_damage:       '#ef4444',
  spell_sustained:    '#f97316',
  attack_sustained:   '#f87171',
  sustain:            '#22c55e',
  defense:            '#3b82f6',
  mobility:           '#06b6d4',
  reach:              '#22c55e',
  waveclear:          '#06b6d4',
  objective_pressure: '#eab308',
  pickoff:            '#ec4899',
